      ...
      <div className="flex gap-[1rem] lg:relative absolute lg:scale-[1.2] scale-[0.8] right-[10px] pt-[0.8rem]">
        <a href="https://www.instagram.com/almondapp.ng/">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="white"
            className="cursor-pointer hover:scale-105 hover:text-[#7D5DF6] hover:fill-current"
          >
            <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21 21 18.761 21 16 L 21 8 C 21 5.239 18.761 3 16 3 L 8 3 z M 18 5 C 18.552 5 19 5.448 19 6 C 19 6.552 18.552 7 18 7 C 17.448 7 17 6.552 17 6 C 17 5.448 17.448 5 18 5 z M 12 7 C 14.761 7 17 9.239 17 12 C 17 14.761 14.761 17 12 17 C 9.239 17 7 14.761 7 12 C 7 9.239 9.239 7 12 7 z M 12 9 A 3 3 0 0 0 9 12 A 3 3 0 0 0 12 15 A 3 3 0 0 0 15 12 A 3 3 0 0 0 12 9 z"></path>
          </svg>
        </a>
        <a href="https://www.facebook.com/profile.php?id=61555046834721&mibextid=zLoPMf">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24px"
        ...
        <a href="https://www.linkedin.com/company/almondnigeria/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
        ...
        <a href="https://www.tiktok.com/@almond.app">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            ...
            viewBox="0 0 50 50"
            fill="white"
            className="cursor-pointer hover:scale-120 hover:text-[#7D5DF6] hover:fill-current"
          >
